...
optimizer = dict(type='SGD', lr=0.0075, momentum=0.9, weight_decay=5e-4)
...
log_level = 'INFO'
# load_from = '/gdata2/zhuqi/work_dirs/tinaface/resume60/epoch_90.pth'
resume_from = '/gdata2/zhuqi/work_dirs/tinaface/resume60/epoch_90.pth'
workflow = [('train', 1)]
work_dir = '/gdata2/zhuqi/work_dirs/tinaface/resume60'
gpu_ids = range(0, 1)
